...
1. Re-tag Docker images.
   CI pushes images to gcr.io, but released images need to be on Docker Hub.
   The script pull images from gcr.io and pushes them to docker.io.
