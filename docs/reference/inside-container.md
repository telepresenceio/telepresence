...
## Run with the daemon and attachment handler in containers
...
The attachment handler (the process that runs locally and optionally will receive intercepted traffic) must also be a docker container,
