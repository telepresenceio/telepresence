...
## Version 2.27.0
## <div style="display:flex;"><img src="images/feature.png" alt="feature" style="width:30px;height:fit-content;"/><div style="display:flex;margin-left:7px;">[Port Information in List Output](reference/client/list)</div></div>
