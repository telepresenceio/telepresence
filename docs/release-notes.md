...
## <div style="display:flex;"><img src="images/feature.png" alt="feature" style="width:30px;height:fit-content;"/><div style="display:flex;margin-left:7px;">Add support for overriding intercepts owned by inactive clients</div></div>
<div style="margin-left: 15px">
