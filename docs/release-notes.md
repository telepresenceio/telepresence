...
## Version 2.26.0
## <div style="display:flex;"><img src="images/feature.png" alt="feature" style="width:30px;height:fit-content;"/><div style="display:flex;margin-left:7px;">[Add configuration to disable global TCP/UDP intercepts](reference/config#intercept)</div></div>
