...
## Version 2.23.4
## <div style="display:flex;"><img src="images/bugfix.png" alt="bugfix" style="width:30px;height:fit-content;"/><div style="display:flex;margin-left:7px;">Use NXDOMAIN instead SERVFAIL for DNS recursion errors (timeouts)</div></div>
