...
## Version 2.25.0
## <div style="display:flex;"><img src="images/feature.png" alt="feature" style="width:30px;height:fit-content;"/><div style="display:flex;margin-left:7px;">Helm chart metadata</div></div>
<div style="margin-left: 15px">

Updated `Chart.yaml` to include keywords and the source repository URL.
