...
following Free and Open Source software:
    ...
    github.com/datawire/ambassador/v2                 v2.1.0                                Apache License 2.0
    github.com/datawire/dlib                          v1.2.5-0.20211116212847-0316f8d7af2b  Apache License 2.0
    github.com/datawire/dtest                         v0.0.0-20210928162311-722b199c4c2f    Apache License 2.0
    github.com/davecgh/go-spew                        v1.1.1                                ISC license
    github.com/docker/cli                             v20.10.12+incompatible                Apache License 2.0
    ...
    github.com/klauspost/compress                     v1.14.1                               3-clause BSD license, Apache License 2.0, MIT license
    ...
    github.com/miekg/dns                              v1.1.45                               3-clause BSD license
    ...
    github.com/rubenv/sql-migrate                     v1.0.0                                MIT license
    ...
    go.starlark.net                                   v0.0.0-20211203141949-70c0e40ae128    3-clause BSD license
    golang.org/x/crypto                               v0.0.0-20220112180741-5e0467b6c7ce    3-clause BSD license
    golang.org/x/mod                                  v0.5.1                                3-clause BSD license
    golang.org/x/net                                  v0.0.0-20220114011407-0dd24b26b47d    3-clause BSD license
    ...
    golang.org/x/sys                                  v0.0.0-20220114195835-da31bd327af9    3-clause BSD license
    ...
    golang.org/x/tools                                v0.1.8                                3-clause BSD license
    ...
    golang.zx2c4.com/wireguard                        v0.0.0-20220117163742-e0b8f11489c5    MIT license
    golang.zx2c4.com/wireguard/windows                v0.5.3                                MIT license
    google.golang.org/appengine                       v1.6.7                                Apache License 2.0
    google.golang.org/genproto                        v0.0.0-20220118154757-00ab72f36ad5    Apache License 2.0
    ...
    helm.sh/helm/v3                                   v3.7.2                                Apache License 2.0
    k8s.io/api                                        v0.23.1                               Apache License 2.0
    k8s.io/apiextensions-apiserver                    v0.23.1                               Apache License 2.0
    k8s.io/apimachinery                               v0.23.1                               3-clause BSD license, Apache License 2.0
    k8s.io/apiserver                                  v0.23.1                               Apache License 2.0
    k8s.io/cli-runtime                                v0.23.1                               Apache License 2.0
    k8s.io/client-go                                  v0.23.1                               3-clause BSD license, Apache License 2.0
    k8s.io/component-base                             v0.23.1                               Apache License 2.0
    k8s.io/klog/v2                                    v2.40.1                               Apache License 2.0
    k8s.io/kube-openapi                               v0.0.0-20220114203427-a0453230fd26    Apache License 2.0
    k8s.io/kubectl                                    v0.23.1                               Apache License 2.0
    k8s.io/kubernetes                                 v1.22.3                               Apache License 2.0
    k8s.io/utils                                      v0.0.0-20211208161948-7d6a63dca704    3-clause BSD license, Apache License 2.0
    oras.land/oras-go                                 v1.1.0                                Apache License 2.0
    sigs.k8s.io/json                                  v0.0.0-20211014215553-94623888fb01    Apache License 2.0
    sigs.k8s.io/kustomize/api                         v0.10.1                               Apache License 2.0
    sigs.k8s.io/kustomize/kyaml                       v0.13.1                               Apache License 2.0, MIT license
