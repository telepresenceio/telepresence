...
require (
	...
	github.com/telepresenceio/telepresence/cmd/cobraparser/v2 v2.0.0-20260531112947-ca14958823ec
	github.com/telepresenceio/telepresence/rpc/v2 v2.28.0
...
require (
	...
	github.com/fclairamb/ftpserverlib v0.32.0 // indirect
