...
require (
	...
	github.com/telepresenceio/telepresence/cmd/cobraparser/v2 v2.0.0-20260419072740-6a47c457d747
	github.com/telepresenceio/telepresence/rpc/v2 v2.28.0-rc.0
