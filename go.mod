...
require (
	...
	github.com/telepresenceio/telepresence/rpc/v2 v2.4.0
...
replace github.com/datawire/dtest v0.0.0-20210803160344-b219a345f448 => github.com/donnyyung/dtest v0.0.0-20210817132025-a9b408f68d4a
