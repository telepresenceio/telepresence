...
require (
	...
	github.com/telepresenceio/telepresence/cmd/cobraparser/v2 v2.0.0-00010101000000-000000000000
	github.com/telepresenceio/telepresence/rpc/v2 v2.26.0-test.7
	...
	gvisor.dev/gvisor v0.0.0-20251114082540-5928db6b1cc3
...
require (
	...
	github.com/telepresenceio/dlib/v2 v2.1.1 // indirect
