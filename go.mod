...
require (
	...
	github.com/telepresenceio/telepresence/rpc/v2 v2.27.0-test.18
	...
	gvisor.dev/gvisor v0.0.0-20260112202126-8cb7a09e3f83
...
require (
	...
	github.com/fclairamb/ftpserverlib v0.29.0 // indirect
