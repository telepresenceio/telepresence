...
require (
	...
	github.com/telepresenceio/telepresence/cmd/cobraparser/v2 v2.0.0-20260506174933-62ee342b2aa9
	github.com/telepresenceio/telepresence/rpc/v2 v2.29.0-test.3
