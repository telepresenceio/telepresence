...
<Alert severity="info">While Telepresence works with any language, this guide uses a sample app written in Node.js. <a href="qs-go/">We also have a version with the sample app written in Go if you prefer</a>.</Alert>
...
<Alert severity="info">While Telepresence works with any language, this guide uses a sample app written in Node.js. <a href="qs-go/#3-install-a-sample-go-application">We also have a version with the sample app written in Go if you prefer</a>.</Alert>
