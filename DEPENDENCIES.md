...
following Free and Open Source software:
    ...
    github.com/containerd/containerd                                             v1.7.17                               Apache License 2.0
    ...
    github.com/docker/cli                                                        v26.1.3+incompatible                  Apache License 2.0
    github.com/docker/distribution                                               v2.8.3+incompatible                   Apache License 2.0
    github.com/docker/docker                                                     v26.1.3+incompatible                  Apache License 2.0
    ...
    golang.org/x/crypto                                                          v0.23.0                               3-clause BSD license
    golang.org/x/exp                                                             v0.0.0-20240530194437-404ba88c7ed0    3-clause BSD license
    golang.org/x/mod                                                             v0.17.0                               3-clause BSD license
    golang.org/x/net                                                             v0.25.0                               3-clause BSD license
    ...
    golang.org/x/tools                                                           v0.21.0                               3-clause BSD license
    ...
    google.golang.org/genproto/googleapis/api                                    v0.0.0-20240528184218-531527333157    Apache License 2.0
    google.golang.org/genproto/googleapis/rpc                                    v0.0.0-20240528184218-531527333157    Apache License 2.0
    google.golang.org/grpc                                                       v1.64.0                               Apache License 2.0
    google.golang.org/protobuf                                                   v1.34.1                               3-clause BSD license
    ...
    gvisor.dev/gvisor                                                            v0.0.0-20240531013208-f549cef38fd6    Apache License 2.0, MIT license
    helm.sh/helm/v3                                                              v3.15.1                               Apache License 2.0
