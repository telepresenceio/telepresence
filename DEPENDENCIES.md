...
following Free and Open Source software:
    ...
    github.com/containerd/containerd                                             v1.7.14                               Apache License 2.0
    ...
    github.com/docker/cli                                                        v26.0.0+incompatible                  Apache License 2.0
    github.com/docker/distribution                                               v2.8.3+incompatible                   Apache License 2.0
    github.com/docker/docker                                                     v26.0.0+incompatible                  Apache License 2.0
    ...
    github.com/prometheus/common                                                 v0.51.1                               Apache License 2.0
    github.com/prometheus/procfs                                                 v0.13.0                               Apache License 2.0
    ...
    go.starlark.net                                                              v0.0.0-20240314022150-ee8ed142361c    3-clause BSD license
    ...
    golang.org/x/tools                                                           v0.19.0                               3-clause BSD license
    ...
    google.golang.org/genproto/googleapis/api                                    v0.0.0-20240325203815-454cdb8f5daa    Apache License 2.0
    google.golang.org/genproto/googleapis/rpc                                    v0.0.0-20240325203815-454cdb8f5daa    Apache License 2.0
    google.golang.org/grpc                                                       v1.62.1                               Apache License 2.0
    ...
    gvisor.dev/gvisor                                                            v0.0.0-20240327015635-5d66c155ccf6    Apache License 2.0, MIT license
    helm.sh/helm/v3                                                              v3.14.3                               Apache License 2.0
    k8s.io/api                                                                   v0.29.3                               Apache License 2.0
    k8s.io/apiextensions-apiserver                                               v0.29.3                               Apache License 2.0
    k8s.io/apimachinery                                                          v0.29.3                               3-clause BSD license, Apache License 2.0
    k8s.io/apiserver                                                             v0.29.3                               Apache License 2.0
    k8s.io/cli-runtime                                                           v0.29.3                               Apache License 2.0
    k8s.io/client-go                                                             v0.29.3                               3-clause BSD license, Apache License 2.0
    k8s.io/component-base                                                        v0.29.3                               Apache License 2.0
    k8s.io/klog/v2                                                               v2.120.1                              Apache License 2.0
    k8s.io/kube-openapi                                                          v0.0.0-20240322212309-b815d8309940    3-clause BSD license, Apache License 2.0
    k8s.io/kubectl                                                               v0.29.3                               Apache License 2.0
