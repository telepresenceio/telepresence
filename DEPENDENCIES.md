...
following Free and Open Source software:
    ...
    github.com/fclairamb/ftpserverlib                                         v0.29.0                               MIT license
    ...
    github.com/miekg/dns                                                      v1.1.70                               3-clause BSD license
    ...
    github.com/puzpuzpuz/xsync/v4                                             v4.3.0                                Apache License 2.0
    ...
    golang.org/x/crypto                                                       v0.47.0                               3-clause BSD license
    golang.org/x/mod                                                          v0.32.0                               3-clause BSD license
    golang.org/x/net                                                          v0.49.0                               3-clause BSD license
    golang.org/x/oauth2                                                       v0.34.0                               3-clause BSD license
    golang.org/x/sync                                                         v0.19.0                               3-clause BSD license
    golang.org/x/sys                                                          v0.40.0                               3-clause BSD license
    golang.org/x/term                                                         v0.39.0                               3-clause BSD license
    golang.org/x/text                                                         v0.33.0                               3-clause BSD license
    golang.org/x/time                                                         v0.14.0                               3-clause BSD license
    golang.org/x/tools                                                        v0.41.0                               3-clause BSD license
    ...
    google.golang.org/genproto/googleapis/rpc                                 v0.0.0-20260112192933-99fd39fd28a9    Apache License 2.0
    ...
    gvisor.dev/gvisor                                                         v0.0.0-20260112202126-8cb7a09e3f83    3-clause BSD license, Apache License 2.0, MIT license
    helm.sh/helm/v3                                                           v3.19.4                               Apache License 2.0
    k8s.io/api                                                                v0.34.3                               Apache License 2.0
    k8s.io/apiextensions-apiserver                                            v0.34.3                               Apache License 2.0
    k8s.io/apimachinery                                                       v0.34.3                               3-clause BSD license, Apache License 2.0
    k8s.io/apiserver                                                          v0.34.3                               Apache License 2.0
    k8s.io/cli-runtime                                                        v0.34.3                               Apache License 2.0
    k8s.io/client-go                                                          v0.34.3                               3-clause BSD license, Apache License 2.0
    k8s.io/component-base                                                     v0.34.3                               Apache License 2.0
    k8s.io/component-helpers                                                  v0.34.3                               Apache License 2.0
    ...
    k8s.io/kubectl                                                            v0.34.3                               Apache License 2.0
    k8s.io/utils                                                              v0.0.0-20260108192941-914a6e750570    3-clause BSD license, Apache License 2.0
