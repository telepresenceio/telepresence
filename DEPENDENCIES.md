...
following Free and Open Source software:
    ...
    github.com/docker/cli                                                        v27.3.1+incompatible                  Apache License 2.0
    github.com/docker/distribution                                               v2.8.3+incompatible                   Apache License 2.0
    github.com/docker/docker                                                     v27.3.1+incompatible                  Apache License 2.0
    ...
    github.com/go-json-experiment/json                                           v0.0.0-20241127185351-9802db03f36a    3-clause BSD license
    ...
    github.com/grpc-ecosystem/grpc-gateway/v2                                    v2.24.0                               3-clause BSD license
    ...
    go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc  v0.57.0                               Apache License 2.0
    go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp                v0.57.0                               Apache License 2.0
    go.opentelemetry.io/otel                                                     v1.32.0                               Apache License 2.0
    go.opentelemetry.io/otel/exporters/otlp/otlptrace                            v1.32.0                               Apache License 2.0
    go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc              v1.32.0                               Apache License 2.0
    go.opentelemetry.io/otel/metric                                              v1.32.0                               Apache License 2.0
    go.opentelemetry.io/otel/sdk                                                 v1.32.0                               Apache License 2.0
    go.opentelemetry.io/otel/trace                                               v1.32.0                               Apache License 2.0
    go.opentelemetry.io/proto/otlp                                               v1.4.0                                Apache License 2.0
    golang.org/x/crypto                                                          v0.31.0                               3-clause BSD license
    golang.org/x/exp                                                             v0.0.0-20241204233417-43b7b7cde48d    3-clause BSD license
    ...
    google.golang.org/genproto/googleapis/api                                    v0.0.0-20241206012308-a4fef0638583    Apache License 2.0
    google.golang.org/genproto/googleapis/rpc                                    v0.0.0-20241206012308-a4fef0638583    Apache License 2.0
    google.golang.org/grpc                                                       v1.68.1                               Apache License 2.0
    ...
    gvisor.dev/gvisor                                                            v0.0.0-20241205222027-1a41c298e490    Apache License 2.0, MIT license
    helm.sh/helm/v3                                                              v3.16.3                               Apache License 2.0
    k8s.io/api                                                                   v0.31.3                               Apache License 2.0
    k8s.io/apiextensions-apiserver                                               v0.31.3                               Apache License 2.0
    k8s.io/apimachinery                                                          v0.31.3                               3-clause BSD license, Apache License 2.0
    k8s.io/apiserver                                                             v0.31.3                               Apache License 2.0
    k8s.io/cli-runtime                                                           v0.31.3                               Apache License 2.0
    k8s.io/client-go                                                             v0.31.3                               3-clause BSD license, Apache License 2.0
    k8s.io/component-base                                                        v0.31.3                               Apache License 2.0
    k8s.io/klog/v2                                                               v2.130.1                              Apache License 2.0
    k8s.io/kube-openapi                                                          v0.0.0-20241127205056-99599406b04f    3-clause BSD license, Apache License 2.0
    k8s.io/kubectl                                                               v0.31.3                               Apache License 2.0
    k8s.io/utils                                                                 v0.0.0-20241104163129-6fe5fd82f078    3-clause BSD license, Apache License 2.0
    ...
    sigs.k8s.io/structured-merge-diff/v4                                         v4.4.3                                Apache License 2.0
