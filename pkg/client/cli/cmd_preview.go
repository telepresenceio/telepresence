...
func addPreviewFlags(prefix string, flags *pflag.FlagSet, spec *manager.PreviewSpec) {
	...
	flags.StringToStringVarP(&spec.InjectHeaders, prefix+"add-headers", "", map[string]string{}, "Additional headers in key1=value1,key2=value2 pairs injected in every preview page request")
}
