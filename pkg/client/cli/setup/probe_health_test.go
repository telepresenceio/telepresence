...
func managerStatefulSet(desired, ready int32) *appsv1.StatefulSet {
	return &appsv1.StatefulSet{
		ObjectMeta: metav1.ObjectMeta{Name: managerStatefulSetName, Namespace: "ambassador"},
...
func TestProbeHealth_QuicAndEndpoints(t *testing.T) {
	t.Run("quic node port allocated", func(t *testing.T) {
		client := fake.NewClientset(managerStatefulSet(1, 1), quicService(corev1.ServiceTypeNodePort, func(svc *corev1.Service) {
