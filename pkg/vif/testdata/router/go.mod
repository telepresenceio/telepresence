...
require github.com/telepresenceio/telepresence/v2 v2.12.2
...
require (
	...
	github.com/telepresenceio/telepresence/rpc/v2 v2.13.1 // indirect
	...
	gvisor.dev/gvisor v0.0.0-20230507020432-0330e87ca888 // indirect
