...
require (
	...
	github.com/telepresenceio/telepresence/v2 v2.29.3
)
...
require (
	...
	github.com/telepresenceio/telepresence/rpc/v2 v2.30.0-rc.1 // indirect
	...
	gvisor.dev/gvisor v0.0.0-20260710194257-2354a1a30e97 // indirect
