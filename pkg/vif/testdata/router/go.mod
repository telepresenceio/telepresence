...
require (
	...
	github.com/telepresenceio/telepresence/v2 v2.23.3
)
...
require (
	...
	github.com/telepresenceio/telepresence/rpc/v2 v2.23.6-rc.0 // indirect
	...
	gvisor.dev/gvisor v0.0.0-20250709194456-2a7b29d5230c // indirect
