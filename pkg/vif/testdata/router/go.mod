...
require (
	...
	github.com/telepresenceio/telepresence/v2 v2.25.0
)
...
require (
	...
	github.com/telepresenceio/telepresence/rpc/v2 v2.26.0-test.7 // indirect
	...
	gvisor.dev/gvisor v0.0.0-20251114082540-5928db6b1cc3 // indirect
