...
| agent.maxIdleTime                                    | maximum time the agent is idle (no engagements to the workload) before it is cleaned up by the traffic manager                                                      |                                                                             |                                                                                   "0h (infinite, never cleaned up)"
