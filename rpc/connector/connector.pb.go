...
type WorkloadInfo struct {
	...
	InterceptInfos []*manager.InterceptInfo `protobuf:"bytes,4,rep,name=intercept_infos,json=interceptInfos,proto3" json:"intercept_infos,omitempty"`
	// InterceptInfos reported from the traffic manager in case the workload is currently intercepted
	IngestInfos []*IngestInfo `protobuf:"bytes,5,rep,name=ingest_infos,json=ingestInfos,proto3" json:"ingest_infos,omitempty"`
...
func (x *WorkloadInfo) GetIngestInfos() []*IngestInfo {
	if x != nil {
		return x.IngestInfos
	}
	return nil
}
...
const file_connector_connector_proto_rawDesc = "" +
	...
	"\x18not_interceptable_reason\x18\x03 \x01(\tR\x16notInterceptableReason\x12L\n" +
	"\x0fintercept_infos\x18\x04 \x03(\v2#.telepresence.manager.InterceptInfoR\x0einterceptInfos\x12E\n" +
	"\fingest_infos\x18\x05 \x03(\v2\".telepresence.connector.IngestInfoR\vingestInfos\x124\n" +
...
var file_connector_connector_proto_depIdxs = []int32{
	...
	38, // 19: telepresence.connector.WorkloadInfo.intercept_infos:type_name -> telepresence.manager.InterceptInfo
	12, // 20: telepresence.connector.WorkloadInfo.ingest_infos:type_name -> telepresence.connector.IngestInfo
