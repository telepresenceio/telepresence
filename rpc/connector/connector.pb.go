...
var file_rpc_connector_connector_proto_rawDesc = []byte{
	...
	0x03, 0x22, 0x4e, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x65,
	...
	0x79, 0x22, 0xeb, 0x01, 0x0a, 0x10, 0x55, 0x6e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x52,
	...
	0x01, 0x32, 0xcc, 0x11, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12,
...
var file_rpc_connector_connector_proto_depIdxs = []int32{
	...
	37, // 13: telepresence.connector.WorkloadInfo.service:type_name -> telepresence.connector.WorkloadInfo.ServiceReference
	18, // 14: telepresence.connector.WorkloadInfoSnapshot.workloads:type_name -> telepresence.connector.WorkloadInfo
	...
	39, // 19: telepresence.connector.LogsResponse.pod_info:type_name -> telepresence.connector.LogsResponse.PodInfoEntry
	32, // 20: telepresence.connector.CommandGroups.Command.flags:type_name -> telepresence.connector.CommandGroups.Flag
	33, // 21: telepresence.connector.CommandGroups.Commands.commands:type_name -> telepresence.connector.CommandGroups.Command
	34, // 22: telepresence.connector.CommandGroups.CommandGroupsEntry.value:type_name -> telepresence.connector.CommandGroups.Commands
	38, // 23: telepresence.connector.WorkloadInfo.ServiceReference.ports:type_name -> telepresence.connector.WorkloadInfo.ServiceReference.Port
	48, // 24: telepresence.connector.Connector.Version:input_type -> google.protobuf.Empty
	9,  // 25: telepresence.connector.Connector.Connect:input_type -> telepresence.connector.ConnectRequest
	48, // 26: telepresence.connector.Connector.Disconnect:input_type -> google.protobuf.Empty
	48, // 27: telepresence.connector.Connector.Status:input_type -> google.protobuf.Empty
	15, // 28: telepresence.connector.Connector.CanIntercept:input_type -> telepresence.connector.CreateInterceptRequest
	15, // 29: telepresence.connector.Connector.CreateIntercept:input_type -> telepresence.connector.CreateInterceptRequest
	49, // 30: telepresence.connector.Connector.RemoveIntercept:input_type -> telepresence.manager.RemoveInterceptRequest2
	12, // 31: telepresence.connector.Connector.Helm:input_type -> telepresence.connector.HelmRequest
	14, // 32: telepresence.connector.Connector.Uninstall:input_type -> telepresence.connector.UninstallRequest
	16, // 33: telepresence.connector.Connector.List:input_type -> telepresence.connector.ListRequest
	17, // 34: telepresence.connector.Connector.WatchWorkloads:input_type -> telepresence.connector.WatchWorkloadsRequest
	48, // 35: telepresence.connector.Connector.UserNotifications:input_type -> google.protobuf.Empty
	22, // 36: telepresence.connector.Connector.Login:input_type -> telepresence.connector.LoginRequest
	48, // 37: telepresence.connector.Connector.Logout:input_type -> google.protobuf.Empty
	24, // 38: telepresence.connector.Connector.GetCloudUserInfo:input_type -> telepresence.connector.UserInfoRequest
	26, // 39: telepresence.connector.Connector.GetCloudAPIKey:input_type -> telepresence.connector.KeyRequest
	28, // 40: telepresence.connector.Connector.GetCloudLicense:input_type -> telepresence.connector.LicenseRequest
	...
	30, // 47: telepresence.connector.Connector.GatherLogs:input_type -> telepresence.connector.LogsRequest
	...
	51, // 50: telepresence.connector.Connector.Version:output_type -> telepresence.common.VersionInfo
	10, // 51: telepresence.connector.Connector.Connect:output_type -> telepresence.connector.ConnectInfo
	48, // 52: telepresence.connector.Connector.Disconnect:output_type -> google.protobuf.Empty
	10, // 53: telepresence.connector.Connector.Status:output_type -> telepresence.connector.ConnectInfo
	20, // 54: telepresence.connector.Connector.CanIntercept:output_type -> telepresence.connector.InterceptResult
	20, // 55: telepresence.connector.Connector.CreateIntercept:output_type -> telepresence.connector.InterceptResult
	20, // 56: telepresence.connector.Connector.RemoveIntercept:output_type -> telepresence.connector.InterceptResult
	13, // 57: telepresence.connector.Connector.Helm:output_type -> telepresence.connector.Result
	13, // 58: telepresence.connector.Connector.Uninstall:output_type -> telepresence.connector.Result
	19, // 59: telepresence.connector.Connector.List:output_type -> telepresence.connector.WorkloadInfoSnapshot
	19, // 60: telepresence.connector.Connector.WatchWorkloads:output_type -> telepresence.connector.WorkloadInfoSnapshot
	21, // 61: telepresence.connector.Connector.UserNotifications:output_type -> telepresence.connector.Notification
	23, // 62: telepresence.connector.Connector.Login:output_type -> telepresence.connector.LoginResult
	48, // 63: telepresence.connector.Connector.Logout:output_type -> google.protobuf.Empty
	25, // 64: telepresence.connector.Connector.GetCloudUserInfo:output_type -> telepresence.connector.UserInfo
	27, // 65: telepresence.connector.Connector.GetCloudAPIKey:output_type -> telepresence.connector.KeyData
	29, // 66: telepresence.connector.Connector.GetCloudLicense:output_type -> telepresence.connector.LicenseData
	11, // 67: telepresence.connector.Connector.GetIngressInfos:output_type -> telepresence.connector.IngressInfos
	48, // 68: telepresence.connector.Connector.SetLogLevel:output_type -> google.protobuf.Empty
	48, // 69: telepresence.connector.Connector.Quit:output_type -> google.protobuf.Empty
	5,  // 70: telepresence.connector.Connector.ListCommands:output_type -> telepresence.connector.CommandGroups
	8,  // 71: telepresence.connector.Connector.RunCommand:output_type -> telepresence.connector.RunCommandResponse
	52, // 72: telepresence.connector.Connector.ResolveIngressInfo:output_type -> telepresence.userdaemon.IngressInfoResponse
	31, // 73: telepresence.connector.Connector.GatherLogs:output_type -> telepresence.connector.LogsResponse
	48, // 74: telepresence.connector.Connector.AddInterceptor:output_type -> google.protobuf.Empty
	48, // 75: telepresence.connector.Connector.RemoveInterceptor:output_type -> google.protobuf.Empty
