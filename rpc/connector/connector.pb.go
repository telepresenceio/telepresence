...
var file_connector_connector_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x73, 0x32, 0xb9, 0x11, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f,
	...
	0x63, 0x65, 0x70, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x48, 0x0a, 0x04, 0x48, 0x65,
...
var file_connector_connector_proto_goTypes = []interface{}{
	...
	(*daemon.SetDNSExcludesRequest)(nil),    // 41: telepresence.daemon.SetDNSExcludesRequest
	(*daemon.SetDNSMappingsRequest)(nil),    // 42: telepresence.daemon.SetDNSMappingsRequest
	(*manager.DNSRequest)(nil),              // 43: telepresence.manager.DNSRequest
	(*manager.LookupHostRequest)(nil),       // 44: telepresence.manager.LookupHostRequest
	(*manager.TunnelMessage)(nil),           // 45: telepresence.manager.TunnelMessage
	(*common.Result)(nil),                   // 46: telepresence.common.Result
	(*manager.VersionInfo2)(nil),            // 47: telepresence.manager.VersionInfo2
	(*manager.CLIConfig)(nil),               // 48: telepresence.manager.CLIConfig
	(*manager.ClusterInfo)(nil),             // 49: telepresence.manager.ClusterInfo
	(*manager.DNSResponse)(nil),             // 50: telepresence.manager.DNSResponse
	(*manager.LookupHostResponse)(nil),      // 51: telepresence.manager.LookupHostResponse
}
var file_connector_connector_proto_depIdxs = []int32{
	...
	8,  // 34: telepresence.connector.Connector.Helm:input_type -> telepresence.connector.HelmRequest
	9,  // 35: telepresence.connector.Connector.Uninstall:input_type -> telepresence.connector.UninstallRequest
	11, // 36: telepresence.connector.Connector.List:input_type -> telepresence.connector.ListRequest
	12, // 37: telepresence.connector.Connector.WatchWorkloads:input_type -> telepresence.connector.WatchWorkloadsRequest
	16, // 38: telepresence.connector.Connector.SetLogLevel:input_type -> telepresence.connector.LogLevelRequest
	38, // 39: telepresence.connector.Connector.Quit:input_type -> google.protobuf.Empty
	17, // 40: telepresence.connector.Connector.GatherLogs:input_type -> telepresence.connector.LogsRequest
	18, // 41: telepresence.connector.Connector.GatherTraces:input_type -> telepresence.connector.TracesRequest
	5,  // 42: telepresence.connector.Connector.AddInterceptor:input_type -> telepresence.connector.Interceptor
	5,  // 43: telepresence.connector.Connector.RemoveInterceptor:input_type -> telepresence.connector.Interceptor
	20, // 44: telepresence.connector.Connector.GetNamespaces:input_type -> telepresence.connector.GetNamespacesRequest
	38, // 45: telepresence.connector.Connector.RemoteMountAvailability:input_type -> google.protobuf.Empty
	38, // 46: telepresence.connector.Connector.GetConfig:input_type -> google.protobuf.Empty
	41, // 47: telepresence.connector.Connector.SetDNSExcludes:input_type -> telepresence.daemon.SetDNSExcludesRequest
	42, // 48: telepresence.connector.Connector.SetDNSMappings:input_type -> telepresence.daemon.SetDNSMappingsRequest
	38, // 49: telepresence.connector.ManagerProxy.Version:input_type -> google.protobuf.Empty
	38, // 50: telepresence.connector.ManagerProxy.GetClientConfig:input_type -> google.protobuf.Empty
	30, // 51: telepresence.connector.ManagerProxy.WatchClusterInfo:input_type -> telepresence.manager.SessionInfo
	43, // 52: telepresence.connector.ManagerProxy.LookupDNS:input_type -> telepresence.manager.DNSRequest
	44, // 53: telepresence.connector.ManagerProxy.LookupHost:input_type -> telepresence.manager.LookupHostRequest
	45, // 54: telepresence.connector.ManagerProxy.Tunnel:input_type -> telepresence.manager.TunnelMessage
	28, // 55: telepresence.connector.Connector.Version:output_type -> telepresence.common.VersionInfo
	28, // 56: telepresence.connector.Connector.RootDaemonVersion:output_type -> telepresence.common.VersionInfo
	28, // 57: telepresence.connector.Connector.TrafficManagerVersion:output_type -> telepresence.common.VersionInfo
	34, // 58: telepresence.connector.Connector.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	7,  // 59: telepresence.connector.Connector.Connect:output_type -> telepresence.connector.ConnectInfo
	38, // 60: telepresence.connector.Connector.Disconnect:output_type -> google.protobuf.Empty
	23, // 61: telepresence.connector.Connector.GetClusterSubnets:output_type -> telepresence.connector.ClusterSubnets
	7,  // 62: telepresence.connector.Connector.Status:output_type -> telepresence.connector.ConnectInfo
	15, // 63: telepresence.connector.Connector.CanIntercept:output_type -> telepresence.connector.InterceptResult
	15, // 64: telepresence.connector.Connector.CreateIntercept:output_type -> telepresence.connector.InterceptResult
	15, // 65: telepresence.connector.Connector.RemoveIntercept:output_type -> telepresence.connector.InterceptResult
	46, // 66: telepresence.connector.Connector.Helm:output_type -> telepresence.common.Result
	46, // 67: telepresence.connector.Connector.Uninstall:output_type -> telepresence.common.Result
	...
	38, // 70: telepresence.connector.Connector.SetLogLevel:output_type -> google.protobuf.Empty
	38, // 71: telepresence.connector.Connector.Quit:output_type -> google.protobuf.Empty
	19, // 72: telepresence.connector.Connector.GatherLogs:output_type -> telepresence.connector.LogsResponse
	46, // 73: telepresence.connector.Connector.GatherTraces:output_type -> telepresence.common.Result
	38, // 74: telepresence.connector.Connector.AddInterceptor:output_type -> google.protobuf.Empty
	38, // 75: telepresence.connector.Connector.RemoveInterceptor:output_type -> google.protobuf.Empty
	21, // 76: telepresence.connector.Connector.GetNamespaces:output_type -> telepresence.connector.GetNamespacesResponse
	46, // 77: telepresence.connector.Connector.RemoteMountAvailability:output_type -> telepresence.common.Result
	22, // 78: telepresence.connector.Connector.GetConfig:output_type -> telepresence.connector.ClientConfig
	38, // 79: telepresence.connector.Connector.SetDNSExcludes:output_type -> google.protobuf.Empty
	38, // 80: telepresence.connector.Connector.SetDNSMappings:output_type -> google.protobuf.Empty
	47, // 81: telepresence.connector.ManagerProxy.Version:output_type -> telepresence.manager.VersionInfo2
	48, // 82: telepresence.connector.ManagerProxy.GetClientConfig:output_type -> telepresence.manager.CLIConfig
	49, // 83: telepresence.connector.ManagerProxy.WatchClusterInfo:output_type -> telepresence.manager.ClusterInfo
	50, // 84: telepresence.connector.ManagerProxy.LookupDNS:output_type -> telepresence.manager.DNSResponse
	51, // 85: telepresence.connector.ManagerProxy.LookupHost:output_type -> telepresence.manager.LookupHostResponse
	45, // 86: telepresence.connector.ManagerProxy.Tunnel:output_type -> telepresence.manager.TunnelMessage
