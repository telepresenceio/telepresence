...
var file_connector_connector_proto_depIdxs = []int32{
	...
	42, // 30: telepresence.connector.Connector.GetIntercept:input_type -> telepresence.manager.GetInterceptRequest
	5,  // 31: telepresence.connector.Connector.Connect:input_type -> telepresence.connector.ConnectRequest
	41, // 32: telepresence.connector.Connector.Disconnect:input_type -> google.protobuf.Empty
	...
	8,  // 35: telepresence.connector.Connector.CanIntercept:input_type -> telepresence.connector.CreateInterceptRequest
	8,  // 36: telepresence.connector.Connector.CreateIntercept:input_type -> telepresence.connector.CreateInterceptRequest
	43, // 37: telepresence.connector.Connector.RemoveIntercept:input_type -> telepresence.manager.RemoveInterceptRequest2
	44, // 38: telepresence.connector.Connector.UpdateIntercept:input_type -> telepresence.manager.UpdateInterceptRequest
	7,  // 39: telepresence.connector.Connector.Uninstall:input_type -> telepresence.connector.UninstallRequest
	9,  // 40: telepresence.connector.Connector.List:input_type -> telepresence.connector.ListRequest
	10, // 41: telepresence.connector.Connector.WatchWorkloads:input_type -> telepresence.connector.WatchWorkloadsRequest
	14, // 42: telepresence.connector.Connector.SetLogLevel:input_type -> telepresence.connector.LogLevelRequest
	41, // 43: telepresence.connector.Connector.Quit:input_type -> google.protobuf.Empty
	15, // 44: telepresence.connector.Connector.GatherLogs:input_type -> telepresence.connector.LogsRequest
	16, // 45: telepresence.connector.Connector.GatherTraces:input_type -> telepresence.connector.TracesRequest
	4,  // 46: telepresence.connector.Connector.AddInterceptor:input_type -> telepresence.connector.Interceptor
	4,  // 47: telepresence.connector.Connector.RemoveInterceptor:input_type -> telepresence.connector.Interceptor
	18, // 48: telepresence.connector.Connector.GetNamespaces:input_type -> telepresence.connector.GetNamespacesRequest
	...
	47, // 55: telepresence.connector.ManagerProxy.EnsureAgent:input_type -> telepresence.manager.EnsureAgentRequest
	34, // 56: telepresence.connector.ManagerProxy.WatchClusterInfo:input_type -> telepresence.manager.SessionInfo
	...
	6,  // 63: telepresence.connector.Connector.Connect:output_type -> telepresence.connector.ConnectInfo
	41, // 64: telepresence.connector.Connector.Disconnect:output_type -> google.protobuf.Empty
	21, // 65: telepresence.connector.Connector.GetClusterSubnets:output_type -> telepresence.connector.ClusterSubnets
	6,  // 66: telepresence.connector.Connector.Status:output_type -> telepresence.connector.ConnectInfo
	13, // 67: telepresence.connector.Connector.CanIntercept:output_type -> telepresence.connector.InterceptResult
	13, // 68: telepresence.connector.Connector.CreateIntercept:output_type -> telepresence.connector.InterceptResult
	13, // 69: telepresence.connector.Connector.RemoveIntercept:output_type -> telepresence.connector.InterceptResult
	37, // 70: telepresence.connector.Connector.UpdateIntercept:output_type -> telepresence.manager.InterceptInfo
	50, // 71: telepresence.connector.Connector.Uninstall:output_type -> telepresence.common.Result
	12, // 72: telepresence.connector.Connector.List:output_type -> telepresence.connector.WorkloadInfoSnapshot
	12, // 73: telepresence.connector.Connector.WatchWorkloads:output_type -> telepresence.connector.WorkloadInfoSnapshot
	41, // 74: telepresence.connector.Connector.SetLogLevel:output_type -> google.protobuf.Empty
	41, // 75: telepresence.connector.Connector.Quit:output_type -> google.protobuf.Empty
	17, // 76: telepresence.connector.Connector.GatherLogs:output_type -> telepresence.connector.LogsResponse
	50, // 77: telepresence.connector.Connector.GatherTraces:output_type -> telepresence.common.Result
	41, // 78: telepresence.connector.Connector.AddInterceptor:output_type -> google.protobuf.Empty
	41, // 79: telepresence.connector.Connector.RemoveInterceptor:output_type -> google.protobuf.Empty
	19, // 80: telepresence.connector.Connector.GetNamespaces:output_type -> telepresence.connector.GetNamespacesResponse
	50, // 81: telepresence.connector.Connector.RemoteMountAvailability:output_type -> telepresence.common.Result
	20, // 82: telepresence.connector.Connector.GetConfig:output_type -> telepresence.connector.ClientConfig
	41, // 83: telepresence.connector.Connector.SetDNSExcludes:output_type -> google.protobuf.Empty
	41, // 84: telepresence.connector.Connector.SetDNSMappings:output_type -> google.protobuf.Empty
	51, // 85: telepresence.connector.ManagerProxy.Version:output_type -> telepresence.manager.VersionInfo2
	52, // 86: telepresence.connector.ManagerProxy.GetClientConfig:output_type -> telepresence.manager.CLIConfig
	41, // 87: telepresence.connector.ManagerProxy.EnsureAgent:output_type -> google.protobuf.Empty
