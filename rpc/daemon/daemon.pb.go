...
var file_daemon_daemon_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0x81, 0x05, 0x0a,
...
var file_daemon_daemon_proto_depIdxs = []int32{
	...
	8,  // 3: telepresence.daemon.DNSConfig.lookup_timeout:type_name -> google.protobuf.Duration
	9,  // 4: telepresence.daemon.OutboundInfo.session:type_name -> telepresence.manager.SessionInfo
	3,  // 5: telepresence.daemon.OutboundInfo.dns:type_name -> telepresence.daemon.DNSConfig
	10, // 6: telepresence.daemon.OutboundInfo.also_proxy_subnets:type_name -> telepresence.manager.IPNet
	10, // 7: telepresence.daemon.OutboundInfo.never_proxy_subnets:type_name -> telepresence.manager.IPNet
	6,  // 8: telepresence.daemon.OutboundInfo.kube_flags:type_name -> telepresence.daemon.OutboundInfo.KubeFlagsEntry
	10, // 9: telepresence.daemon.NetworkConfig.subnets:type_name -> telepresence.manager.IPNet
	4,  // 10: telepresence.daemon.NetworkConfig.outbound_info:type_name -> telepresence.daemon.OutboundInfo
	11, // 11: telepresence.daemon.Daemon.Version:input_type -> google.protobuf.Empty
	11, // 12: telepresence.daemon.Daemon.Status:input_type -> google.protobuf.Empty
	11, // 13: telepresence.daemon.Daemon.Quit:input_type -> google.protobuf.Empty
	4,  // 14: telepresence.daemon.Daemon.Connect:input_type -> telepresence.daemon.OutboundInfo
	11, // 15: telepresence.daemon.Daemon.Disconnect:input_type -> google.protobuf.Empty
	11, // 16: telepresence.daemon.Daemon.GetNetworkConfig:input_type -> google.protobuf.Empty
	1,  // 17: telepresence.daemon.Daemon.SetDnsSearchPath:input_type -> telepresence.daemon.Paths
	12, // 18: telepresence.daemon.Daemon.SetLogLevel:input_type -> telepresence.manager.LogLevelRequest
	11, // 19: telepresence.daemon.Daemon.WaitForNetwork:input_type -> google.protobuf.Empty
	7,  // 20: telepresence.daemon.Daemon.Version:output_type -> telepresence.common.VersionInfo
	0,  // 21: telepresence.daemon.Daemon.Status:output_type -> telepresence.daemon.DaemonStatus
	11, // 22: telepresence.daemon.Daemon.Quit:output_type -> google.protobuf.Empty
	0,  // 23: telepresence.daemon.Daemon.Connect:output_type -> telepresence.daemon.DaemonStatus
	11, // 24: telepresence.daemon.Daemon.Disconnect:output_type -> google.protobuf.Empty
	5,  // 25: telepresence.daemon.Daemon.GetNetworkConfig:output_type -> telepresence.daemon.NetworkConfig
	11, // 26: telepresence.daemon.Daemon.SetDnsSearchPath:output_type -> google.protobuf.Empty
	11, // 27: telepresence.daemon.Daemon.SetLogLevel:output_type -> google.protobuf.Empty
	11, // 28: telepresence.daemon.Daemon.WaitForNetwork:output_type -> google.protobuf.Empty
