...
const (
	SystemACli_GetUnauthenticatedCommandMessages_FullMethodName = "/telepresence.systema.SystemACli/GetUnauthenticatedCommandMessages"
)
...
func (c *systemACliClient) GetUnauthenticatedCommandMessages(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CommandMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, SystemACli_GetUnauthenticatedCommandMessages_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SystemACli_GetUnauthenticatedCommandMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SystemACli_GetUnauthenticatedCommandMessages_FullMethodName,
	}
