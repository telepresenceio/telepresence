...
func file_authenticator_authenticator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_authenticator_authenticator_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_authenticator_authenticator_proto_msgTypes[1].Exporter = func(v any, i int) any {
