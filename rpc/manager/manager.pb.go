...
type RevokeInterceptRequest struct {
	...
	// Authentication token for verifying the caller's identity and permissions
...
func (x *RevokeInterceptRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_manager_manager_proto_rawDesc = "" +
	...
	"\fintercept_id\x18\x01 \x01(\tR\vinterceptId\x12\x14\n" +
	...
	"\x0fRemoveIntercept\x12-.telepresence.manager.RemoveInterceptRequest2\x1a\x16.google.protobuf.Empty\x12W\n" +
	"\x0fRevokeIntercept\x12,.telepresence.manager.RevokeInterceptRequest\x1a\x16.google.protobuf.Empty\x12^\n" +
...
var file_manager_manager_proto_goTypes = []any{
	...
	(*RevokeInterceptRequest)(nil),  // 22: telepresence.manager.RevokeInterceptRequest
	...
	nil,                             // 61: telepresence.manager.InterceptSpec.HeaderFiltersEntry
	nil,                             // 62: telepresence.manager.InterceptSpec.MetadataEntry
	nil,                             // 63: telepresence.manager.InterceptInfo.EnvironmentEntry
	nil,                             // 64: telepresence.manager.InterceptInfo.MountsEntry
	nil,                             // 65: telepresence.manager.AgentInfoDelta.UpsertsEntry
	nil,                             // 66: telepresence.manager.InterceptInfoDelta.UpsertsEntry
	nil,                             // 67: telepresence.manager.ReviewInterceptRequest.EnvironmentEntry
	nil,                             // 68: telepresence.manager.ReviewInterceptRequest.MountsEntry
	nil,                             // 69: telepresence.manager.LogsResponse.PodLogsEntry
	nil,                             // 70: telepresence.manager.LogsResponse.PodYamlEntry
	nil,                             // 71: telepresence.manager.AgentPodInfoDelta.UpsertsEntry
...
var file_manager_manager_proto_depIdxs = []int32{
	...
	61,  // 2: telepresence.manager.InterceptSpec.header_filters:type_name -> telepresence.manager.InterceptSpec.HeaderFiltersEntry
	62,  // 3: telepresence.manager.InterceptSpec.metadata:type_name -> telepresence.manager.InterceptSpec.MetadataEntry
	...
	63,  // 7: telepresence.manager.InterceptInfo.environment:type_name -> telepresence.manager.InterceptInfo.EnvironmentEntry
	64,  // 8: telepresence.manager.InterceptInfo.mounts:type_name -> telepresence.manager.InterceptInfo.MountsEntry
	73,  // 9: telepresence.manager.InterceptInfo.modified_at:type_name -> google.protobuf.Timestamp
	...
	65,  // 18: telepresence.manager.AgentInfoDelta.upserts:type_name -> telepresence.manager.AgentInfoDelta.UpsertsEntry
	9,   // 19: telepresence.manager.InterceptInfoSnapshot.intercepts:type_name -> telepresence.manager.InterceptInfo
	66,  // 20: telepresence.manager.InterceptInfoDelta.upserts:type_name -> telepresence.manager.InterceptInfoDelta.UpsertsEntry
	...
	67,  // 28: telepresence.manager.ReviewInterceptRequest.environment:type_name -> telepresence.manager.ReviewInterceptRequest.EnvironmentEntry
	68,  // 29: telepresence.manager.ReviewInterceptRequest.mounts:type_name -> telepresence.manager.ReviewInterceptRequest.MountsEntry
	12,  // 30: telepresence.manager.RemainRequest.session:type_name -> telepresence.manager.SessionInfo
	74,  // 31: telepresence.manager.LogLevelRequest.duration:type_name -> google.protobuf.Duration
	69,  // 32: telepresence.manager.LogsResponse.pod_logs:type_name -> telepresence.manager.LogsResponse.PodLogsEntry
	70,  // 33: telepresence.manager.LogsResponse.pod_yaml:type_name -> telepresence.manager.LogsResponse.PodYamlEntry
	...
	35,  // 37: telepresence.manager.DNSAgentResponse.request:type_name -> telepresence.manager.DNSRequest
	36,  // 38: telepresence.manager.DNSAgentResponse.response:type_name -> telepresence.manager.DNSResponse
	38,  // 39: telepresence.manager.ClusterInfo.service_subnet:type_name -> telepresence.manager.IPNet
	38,  // 40: telepresence.manager.ClusterInfo.pod_subnets:type_name -> telepresence.manager.IPNet
	40,  // 41: telepresence.manager.ClusterInfo.routing:type_name -> telepresence.manager.Routing
	41,  // 42: telepresence.manager.ClusterInfo.dns:type_name -> telepresence.manager.DNS
	38,  // 43: telepresence.manager.Routing.also_proxy_subnets:type_name -> telepresence.manager.IPNet
	38,  // 44: telepresence.manager.Routing.never_proxy_subnets:type_name -> telepresence.manager.IPNet
	38,  // 45: telepresence.manager.Routing.allow_conflicting_subnets:type_name -> telepresence.manager.IPNet
	44,  // 46: telepresence.manager.AgentPodInfoSnapshot.agents:type_name -> telepresence.manager.AgentPodInfo
	71,  // 47: telepresence.manager.AgentPodInfoDelta.upserts:type_name -> telepresence.manager.AgentPodInfoDelta.UpsertsEntry
	...
	72,  // 52: telepresence.manager.WorkloadInfo.intercept_clients:type_name -> telepresence.manager.WorkloadInfo.Intercept
	...
	51,  // 55: telepresence.manager.WorkloadEvent.workload:type_name -> telepresence.manager.WorkloadInfo
	73,  // 56: telepresence.manager.WorkloadEventsDelta.since:type_name -> google.protobuf.Timestamp
	52,  // 57: telepresence.manager.WorkloadEventsDelta.events:type_name -> telepresence.manager.WorkloadEvent
	12,  // 58: telepresence.manager.WorkloadEventsRequest.session_info:type_name -> telepresence.manager.SessionInfo
	73,  // 59: telepresence.manager.WorkloadEventsRequest.since:type_name -> google.protobuf.Timestamp
	12,  // 60: telepresence.manager.UninstallAgentsRequest.session_info:type_name -> telepresence.manager.SessionInfo
	59,  // 61: telepresence.manager.AgentInfo.ContainerInfo.environment:type_name -> telepresence.manager.AgentInfo.ContainerInfo.EnvironmentEntry
	60,  // 62: telepresence.manager.AgentInfo.ContainerInfo.mounts:type_name -> telepresence.manager.AgentInfo.ContainerInfo.MountsEntry
	57,  // 63: telepresence.manager.AgentInfo.ContainersEntry.value:type_name -> telepresence.manager.AgentInfo.ContainerInfo
	...
	44,  // 66: telepresence.manager.AgentPodInfoDelta.UpsertsEntry.value:type_name -> telepresence.manager.AgentPodInfo
	75,  // 67: telepresence.manager.Manager.Version:input_type -> google.protobuf.Empty
	75,  // 68: telepresence.manager.Manager.GetAgentImageFQN:input_type -> google.protobuf.Empty
	47,  // 69: telepresence.manager.Manager.GetAgentConfig:input_type -> telepresence.manager.AgentConfigRequest
	75,  // 70: telepresence.manager.Manager.GetClientConfig:input_type -> google.protobuf.Empty
	75,  // 71: telepresence.manager.Manager.GetTelepresenceAPI:input_type -> google.protobuf.Empty
	...
	25,  // 76: telepresence.manager.Manager.Remain:input_type -> telepresence.manager.RemainRequest
	12,  // 77: telepresence.manager.Manager.Depart:input_type -> telepresence.manager.SessionInfo
	26,  // 78: telepresence.manager.Manager.SetLogLevel:input_type -> telepresence.manager.LogLevelRequest
	27,  // 79: telepresence.manager.Manager.GetLogs:input_type -> telepresence.manager.GetLogsRequest
	...
	54,  // 86: telepresence.manager.Manager.WatchWorkloads:input_type -> telepresence.manager.WorkloadEventsRequest
	...
	22,  // 92: telepresence.manager.Manager.RevokeIntercept:input_type -> telepresence.manager.RevokeInterceptRequest
	23,  // 93: telepresence.manager.Manager.GetIntercept:input_type -> telepresence.manager.GetInterceptRequest
	24,  // 94: telepresence.manager.Manager.ReviewIntercept:input_type -> telepresence.manager.ReviewInterceptRequest
	12,  // 95: telepresence.manager.Manager.GetKnownWorkloadKinds:input_type -> telepresence.manager.SessionInfo
	33,  // 96: telepresence.manager.Manager.Lookup:input_type -> telepresence.manager.LookupRequest
	35,  // 97: telepresence.manager.Manager.LookupDNS:input_type -> telepresence.manager.DNSRequest
	75,  // 98: telepresence.manager.Manager.WatchLogLevel:input_type -> google.protobuf.Empty
	31,  // 99: telepresence.manager.Manager.Tunnel:input_type -> telepresence.manager.TunnelMessage
	49,  // 100: telepresence.manager.Manager.ReportMetrics:input_type -> telepresence.manager.TunnelMetrics
	55,  // 101: telepresence.manager.Manager.UninstallAgents:input_type -> telepresence.manager.UninstallAgentsRequest
	30,  // 102: telepresence.manager.Manager.Version:output_type -> telepresence.manager.VersionInfo2
	43,  // 103: telepresence.manager.Manager.GetAgentImageFQN:output_type -> telepresence.manager.AgentImageFQN
	48,  // 104: telepresence.manager.Manager.GetAgentConfig:output_type -> telepresence.manager.AgentConfigResponse
	42,  // 105: telepresence.manager.Manager.GetClientConfig:output_type -> telepresence.manager.CLIConfig
	29,  // 106: telepresence.manager.Manager.GetTelepresenceAPI:output_type -> telepresence.manager.TelepresenceAPIInfo
	12,  // 107: telepresence.manager.Manager.ArriveAsClient:output_type -> telepresence.manager.SessionInfo
	75,  // 108: telepresence.manager.Manager.ReconnectAgent:output_type -> google.protobuf.Empty
	75,  // 109: telepresence.manager.Manager.ReconnectClient:output_type -> google.protobuf.Empty
	12,  // 110: telepresence.manager.Manager.ArriveAsAgent:output_type -> telepresence.manager.SessionInfo
	75,  // 111: telepresence.manager.Manager.Remain:output_type -> google.protobuf.Empty
	75,  // 112: telepresence.manager.Manager.Depart:output_type -> google.protobuf.Empty
	75,  // 113: telepresence.manager.Manager.SetLogLevel:output_type -> google.protobuf.Empty
	28,  // 114: telepresence.manager.Manager.GetLogs:output_type -> telepresence.manager.LogsResponse
	45,  // 115: telepresence.manager.Manager.WatchAgentPods:output_type -> telepresence.manager.AgentPodInfoSnapshot
	46,  // 116: telepresence.manager.Manager.WatchAgentPodsDelta:output_type -> telepresence.manager.AgentPodInfoDelta
	...
	53,  // 121: telepresence.manager.Manager.WatchWorkloads:output_type -> telepresence.manager.WorkloadEventsDelta
	39,  // 122: telepresence.manager.Manager.WatchClusterInfo:output_type -> telepresence.manager.ClusterInfo
	...
	75,  // 126: telepresence.manager.Manager.RemoveIntercept:output_type -> google.protobuf.Empty
	75,  // 127: telepresence.manager.Manager.RevokeIntercept:output_type -> google.protobuf.Empty
	9,   // 128: telepresence.manager.Manager.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	75,  // 129: telepresence.manager.Manager.ReviewIntercept:output_type -> google.protobuf.Empty
	50,  // 130: telepresence.manager.Manager.GetKnownWorkloadKinds:output_type -> telepresence.manager.KnownWorkloadKinds
	34,  // 131: telepresence.manager.Manager.Lookup:output_type -> telepresence.manager.LookupResponse
	36,  // 132: telepresence.manager.Manager.LookupDNS:output_type -> telepresence.manager.DNSResponse
	26,  // 133: telepresence.manager.Manager.WatchLogLevel:output_type -> telepresence.manager.LogLevelRequest
	31,  // 134: telepresence.manager.Manager.Tunnel:output_type -> telepresence.manager.TunnelMessage
	75,  // 135: telepresence.manager.Manager.ReportMetrics:output_type -> google.protobuf.Empty
	75,  // 136: telepresence.manager.Manager.UninstallAgents:output_type -> google.protobuf.Empty
