...
var file_rpc_manager_manager_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x6d, 0x61, 0x73, 0x6b, 0x22, 0xfc, 0x01, 0x0a, 0x0b, 0x43, 0x6c, 0x75, 0x73, 0x74,
	...
	0x50, 0x6f, 0x64, 0x49, 0x70, 0x2a, 0xa0, 0x01, 0x0a, 0x18, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x63,
	0x65, 0x70, 0x74, 0x44, 0x69, 0x73, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79,
...
var file_rpc_manager_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_rpc_manager_manager_proto_goTypes = []interface{}{
	...
	nil,                               // 36: telepresence.manager.PreviewSpec.AddRequestHeadersEntry
	nil,                               // 37: telepresence.manager.InterceptInfo.HeadersEntry
	nil,                               // 38: telepresence.manager.InterceptInfo.MetadataEntry
	nil,                               // 39: telepresence.manager.InterceptInfo.EnvironmentEntry
	nil,                               // 40: telepresence.manager.ReviewInterceptRequest.HeadersEntry
	nil,                               // 41: telepresence.manager.ReviewInterceptRequest.MetadataEntry
	nil,                               // 42: telepresence.manager.ReviewInterceptRequest.EnvironmentEntry
	nil,                               // 43: telepresence.manager.LogsResponse.PodLogsEntry
	nil,                               // 44: telepresence.manager.LogsResponse.PodYamlEntry
...
var file_rpc_manager_manager_proto_depIdxs = []int32{
	...
	36, // 3: telepresence.manager.PreviewSpec.add_request_headers:type_name -> telepresence.manager.PreviewSpec.AddRequestHeadersEntry
	...
	37, // 8: telepresence.manager.InterceptInfo.headers:type_name -> telepresence.manager.InterceptInfo.HeadersEntry
	38, // 9: telepresence.manager.InterceptInfo.metadata:type_name -> telepresence.manager.InterceptInfo.MetadataEntry
	39, // 10: telepresence.manager.InterceptInfo.environment:type_name -> telepresence.manager.InterceptInfo.EnvironmentEntry
	...
	40, // 22: telepresence.manager.ReviewInterceptRequest.headers:type_name -> telepresence.manager.ReviewInterceptRequest.HeadersEntry
	41, // 23: telepresence.manager.ReviewInterceptRequest.metadata:type_name -> telepresence.manager.ReviewInterceptRequest.MetadataEntry
	42, // 24: telepresence.manager.ReviewInterceptRequest.environment:type_name -> telepresence.manager.ReviewInterceptRequest.EnvironmentEntry
	7,  // 25: telepresence.manager.RemainRequest.session:type_name -> telepresence.manager.SessionInfo
	45, // 26: telepresence.manager.LogLevelRequest.duration:type_name -> google.protobuf.Duration
	43, // 27: telepresence.manager.LogsResponse.pod_logs:type_name -> telepresence.manager.LogsResponse.PodLogsEntry
	44, // 28: telepresence.manager.LogsResponse.pod_yaml:type_name -> telepresence.manager.LogsResponse.PodYamlEntry
	...
	46, // 35: telepresence.manager.Manager.Version:input_type -> google.protobuf.Empty
	46, // 36: telepresence.manager.Manager.GetLicense:input_type -> google.protobuf.Empty
	46, // 37: telepresence.manager.Manager.CanConnectAmbassadorCloud:input_type -> google.protobuf.Empty
	46, // 38: telepresence.manager.Manager.GetCloudConfig:input_type -> google.protobuf.Empty
	46, // 39: telepresence.manager.Manager.GetTelepresenceAPI:input_type -> google.protobuf.Empty
	1,  // 40: telepresence.manager.Manager.ArriveAsClient:input_type -> telepresence.manager.ClientInfo
	2,  // 41: telepresence.manager.Manager.ArriveAsAgent:input_type -> telepresence.manager.AgentInfo
	17, // 42: telepresence.manager.Manager.Remain:input_type -> telepresence.manager.RemainRequest
	7,  // 43: telepresence.manager.Manager.Depart:input_type -> telepresence.manager.SessionInfo
	18, // 44: telepresence.manager.Manager.SetLogLevel:input_type -> telepresence.manager.LogLevelRequest
	19, // 45: telepresence.manager.Manager.GetLogs:input_type -> telepresence.manager.GetLogsRequest
	7,  // 46: telepresence.manager.Manager.WatchAgents:input_type -> telepresence.manager.SessionInfo
	8,  // 47: telepresence.manager.Manager.WatchAgentsNS:input_type -> telepresence.manager.AgentsRequest
	7,  // 48: telepresence.manager.Manager.WatchIntercepts:input_type -> telepresence.manager.SessionInfo
	7,  // 49: telepresence.manager.Manager.WatchClusterInfo:input_type -> telepresence.manager.SessionInfo
	11, // 50: telepresence.manager.Manager.PrepareIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	11, // 51: telepresence.manager.Manager.CreateIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	14, // 52: telepresence.manager.Manager.RemoveIntercept:input_type -> telepresence.manager.RemoveInterceptRequest2
	13, // 53: telepresence.manager.Manager.UpdateIntercept:input_type -> telepresence.manager.UpdateInterceptRequest
	15, // 54: telepresence.manager.Manager.GetIntercept:input_type -> telepresence.manager.GetInterceptRequest
	16, // 55: telepresence.manager.Manager.ReviewIntercept:input_type -> telepresence.manager.ReviewInterceptRequest
	26, // 56: telepresence.manager.Manager.ClientTunnel:input_type -> telepresence.manager.ConnMessage
	26, // 57: telepresence.manager.Manager.AgentTunnel:input_type -> telepresence.manager.ConnMessage
	29, // 58: telepresence.manager.Manager.LookupHost:input_type -> telepresence.manager.LookupHostRequest
	31, // 59: telepresence.manager.Manager.AgentLookupHostResponse:input_type -> telepresence.manager.LookupHostAgentResponse
	7,  // 60: telepresence.manager.Manager.WatchLookupHost:input_type -> telepresence.manager.SessionInfo
	46, // 61: telepresence.manager.Manager.WatchLogLevel:input_type -> google.protobuf.Empty
	27, // 62: telepresence.manager.Manager.Tunnel:input_type -> telepresence.manager.TunnelMessage
	7,  // 63: telepresence.manager.Manager.WatchDial:input_type -> telepresence.manager.SessionInfo
	22, // 64: telepresence.manager.Manager.Version:output_type -> telepresence.manager.VersionInfo2
	23, // 65: telepresence.manager.Manager.GetLicense:output_type -> telepresence.manager.License
	25, // 66: telepresence.manager.Manager.CanConnectAmbassadorCloud:output_type -> telepresence.manager.AmbassadorCloudConnection
	24, // 67: telepresence.manager.Manager.GetCloudConfig:output_type -> telepresence.manager.AmbassadorCloudConfig
	21, // 68: telepresence.manager.Manager.GetTelepresenceAPI:output_type -> telepresence.manager.TelepresenceAPIInfo
	7,  // 69: telepresence.manager.Manager.ArriveAsClient:output_type -> telepresence.manager.SessionInfo
	7,  // 70: telepresence.manager.Manager.ArriveAsAgent:output_type -> telepresence.manager.SessionInfo
	46, // 71: telepresence.manager.Manager.Remain:output_type -> google.protobuf.Empty
	46, // 72: telepresence.manager.Manager.Depart:output_type -> google.protobuf.Empty
	46, // 73: telepresence.manager.Manager.SetLogLevel:output_type -> google.protobuf.Empty
	20, // 74: telepresence.manager.Manager.GetLogs:output_type -> telepresence.manager.LogsResponse
	9,  // 75: telepresence.manager.Manager.WatchAgents:output_type -> telepresence.manager.AgentInfoSnapshot
	9,  // 76: telepresence.manager.Manager.WatchAgentsNS:output_type -> telepresence.manager.AgentInfoSnapshot
	10, // 77: telepresence.manager.Manager.WatchIntercepts:output_type -> telepresence.manager.InterceptInfoSnapshot
	33, // 78: telepresence.manager.Manager.WatchClusterInfo:output_type -> telepresence.manager.ClusterInfo
	12, // 79: telepresence.manager.Manager.PrepareIntercept:output_type -> telepresence.manager.PreparedIntercept
	6,  // 80: telepresence.manager.Manager.CreateIntercept:output_type -> telepresence.manager.InterceptInfo
	46, // 81: telepresence.manager.Manager.RemoveIntercept:output_type -> google.protobuf.Empty
	6,  // 82: telepresence.manager.Manager.UpdateIntercept:output_type -> telepresence.manager.InterceptInfo
	6,  // 83: telepresence.manager.Manager.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	46, // 84: telepresence.manager.Manager.ReviewIntercept:output_type -> google.protobuf.Empty
	26, // 85: telepresence.manager.Manager.ClientTunnel:output_type -> telepresence.manager.ConnMessage
	26, // 86: telepresence.manager.Manager.AgentTunnel:output_type -> telepresence.manager.ConnMessage
	30, // 87: telepresence.manager.Manager.LookupHost:output_type -> telepresence.manager.LookupHostResponse
	46, // 88: telepresence.manager.Manager.AgentLookupHostResponse:output_type -> google.protobuf.Empty
	29, // 89: telepresence.manager.Manager.WatchLookupHost:output_type -> telepresence.manager.LookupHostRequest
	18, // 90: telepresence.manager.Manager.WatchLogLevel:output_type -> telepresence.manager.LogLevelRequest
	27, // 91: telepresence.manager.Manager.Tunnel:output_type -> telepresence.manager.TunnelMessage
	28, // 92: telepresence.manager.Manager.WatchDial:output_type -> telepresence.manager.DialRequest
