...
var file_manager_manager_proto_depIdxs = []int32{
	...
	12,  // 86: telepresence.manager.Manager.WatchAgents:input_type -> telepresence.manager.SessionInfo
	12,  // 87: telepresence.manager.Manager.WatchAgentsDelta:input_type -> telepresence.manager.SessionInfo
	12,  // 88: telepresence.manager.Manager.WatchIntercepts:input_type -> telepresence.manager.SessionInfo
	12,  // 89: telepresence.manager.Manager.WatchInterceptsDelta:input_type -> telepresence.manager.SessionInfo
	56,  // 90: telepresence.manager.Manager.WatchWorkloads:input_type -> telepresence.manager.WorkloadEventsRequest
	12,  // 91: telepresence.manager.Manager.WatchClusterInfo:input_type -> telepresence.manager.SessionInfo
	19,  // 92: telepresence.manager.Manager.EnsureAgent:input_type -> telepresence.manager.EnsureAgentRequest
	18,  // 93: telepresence.manager.Manager.PrepareIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	18,  // 94: telepresence.manager.Manager.CreateIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	21,  // 95: telepresence.manager.Manager.RemoveIntercept:input_type -> telepresence.manager.RemoveInterceptRequest2
	22,  // 96: telepresence.manager.Manager.GetIntercept:input_type -> telepresence.manager.GetInterceptRequest
	23,  // 97: telepresence.manager.Manager.ReviewIntercept:input_type -> telepresence.manager.ReviewInterceptRequest
	12,  // 98: telepresence.manager.Manager.GetKnownWorkloadKinds:input_type -> telepresence.manager.SessionInfo
	32,  // 99: telepresence.manager.Manager.Lookup:input_type -> telepresence.manager.LookupRequest
	34,  // 100: telepresence.manager.Manager.LookupDNS:input_type -> telepresence.manager.DNSRequest
	77,  // 101: telepresence.manager.Manager.WatchLogLevel:input_type -> google.protobuf.Empty
	30,  // 102: telepresence.manager.Manager.Tunnel:input_type -> telepresence.manager.TunnelMessage
	48,  // 103: telepresence.manager.Manager.ReportMetrics:input_type -> telepresence.manager.TunnelMetrics
	57,  // 104: telepresence.manager.Manager.UninstallAgents:input_type -> telepresence.manager.UninstallAgentsRequest
	29,  // 105: telepresence.manager.Manager.Version:output_type -> telepresence.manager.VersionInfo2
	42,  // 106: telepresence.manager.Manager.GetAgentImageFQN:output_type -> telepresence.manager.AgentImageFQN
	47,  // 107: telepresence.manager.Manager.GetAgentConfig:output_type -> telepresence.manager.AgentConfigResponse
	41,  // 108: telepresence.manager.Manager.GetClientConfig:output_type -> telepresence.manager.CLIConfig
	28,  // 109: telepresence.manager.Manager.GetTelepresenceAPI:output_type -> telepresence.manager.TelepresenceAPIInfo
	12,  // 110: telepresence.manager.Manager.ArriveAsClient:output_type -> telepresence.manager.SessionInfo
	77,  // 111: telepresence.manager.Manager.ReconnectAgent:output_type -> google.protobuf.Empty
	77,  // 112: telepresence.manager.Manager.ReconnectClient:output_type -> google.protobuf.Empty
	12,  // 113: telepresence.manager.Manager.ArriveAsAgent:output_type -> telepresence.manager.SessionInfo
	77,  // 114: telepresence.manager.Manager.Remain:output_type -> google.protobuf.Empty
	77,  // 115: telepresence.manager.Manager.Depart:output_type -> google.protobuf.Empty
	77,  // 116: telepresence.manager.Manager.SetLogLevel:output_type -> google.protobuf.Empty
	27,  // 117: telepresence.manager.Manager.GetLogs:output_type -> telepresence.manager.LogsResponse
	44,  // 118: telepresence.manager.Manager.WatchAgentPods:output_type -> telepresence.manager.AgentPodInfoSnapshot
	45,  // 119: telepresence.manager.Manager.WatchAgentPodsDelta:output_type -> telepresence.manager.AgentPodInfoDelta
	14,  // 120: telepresence.manager.Manager.WatchAgents:output_type -> telepresence.manager.AgentInfoSnapshot
	15,  // 121: telepresence.manager.Manager.WatchAgentsDelta:output_type -> telepresence.manager.AgentInfoDelta
	16,  // 122: telepresence.manager.Manager.WatchIntercepts:output_type -> telepresence.manager.InterceptInfoSnapshot
	17,  // 123: telepresence.manager.Manager.WatchInterceptsDelta:output_type -> telepresence.manager.InterceptInfoDelta
	55,  // 124: telepresence.manager.Manager.WatchWorkloads:output_type -> telepresence.manager.WorkloadEventsDelta
	38,  // 125: telepresence.manager.Manager.WatchClusterInfo:output_type -> telepresence.manager.ClusterInfo
	14,  // 126: telepresence.manager.Manager.EnsureAgent:output_type -> telepresence.manager.AgentInfoSnapshot
	20,  // 127: telepresence.manager.Manager.PrepareIntercept:output_type -> telepresence.manager.PreparedIntercept
	9,   // 128: telepresence.manager.Manager.CreateIntercept:output_type -> telepresence.manager.InterceptInfo
	77,  // 129: telepresence.manager.Manager.RemoveIntercept:output_type -> google.protobuf.Empty
	9,   // 130: telepresence.manager.Manager.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	77,  // 131: telepresence.manager.Manager.ReviewIntercept:output_type -> google.protobuf.Empty
	49,  // 132: telepresence.manager.Manager.GetKnownWorkloadKinds:output_type -> telepresence.manager.KnownWorkloadKinds
	33,  // 133: telepresence.manager.Manager.Lookup:output_type -> telepresence.manager.LookupResponse
	35,  // 134: telepresence.manager.Manager.LookupDNS:output_type -> telepresence.manager.DNSResponse
	25,  // 135: telepresence.manager.Manager.WatchLogLevel:output_type -> telepresence.manager.LogLevelRequest
	30,  // 136: telepresence.manager.Manager.Tunnel:output_type -> telepresence.manager.TunnelMessage
	77,  // 137: telepresence.manager.Manager.ReportMetrics:output_type -> google.protobuf.Empty
	77,  // 138: telepresence.manager.Manager.UninstallAgents:output_type -> google.protobuf.Empty
