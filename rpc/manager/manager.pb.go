...
type UpdateInterceptRequest struct {
	...
	Session *SessionInfo `protobuf:"bytes,1,opt,name=session,proto3" json:"session,omitempty"`
	// You may either refer to the intercept by its name (scoped to the
	// client session), or by its ID (scoped to the manager).  You MUST
	// use the ID instead of the name if you don't set the session
	// (above).
	//
	// Types that are assignable to Intercept:
	//	*UpdateInterceptRequest_Name
	//	*UpdateInterceptRequest_Id
	Intercept isUpdateInterceptRequest_Intercept `protobuf_oneof:"intercept"`
...
func (m *UpdateInterceptRequest) GetIntercept() isUpdateInterceptRequest_Intercept {
	if m != nil {
		return m.Intercept
	}
	return nil
...
func (x *UpdateInterceptRequest) GetName() string {
	if x, ok := x.GetIntercept().(*UpdateInterceptRequest_Name); ok {
		return x.Name
	}
	return ""
}

func (x *UpdateInterceptRequest) GetId() string {
	if x, ok := x.GetIntercept().(*UpdateInterceptRequest_Id); ok {
		return x.Id
	}
	return ""
}
...
type isUpdateInterceptRequest_Intercept interface {
	isUpdateInterceptRequest_Intercept()
}

type UpdateInterceptRequest_Name struct {
	Name string `protobuf:"bytes,6,opt,name=name,proto3,oneof"`
}

type UpdateInterceptRequest_Id struct {
	Id string `protobuf:"bytes,2,opt,name=id,proto3,oneof"`
}

func (*UpdateInterceptRequest_Name) isUpdateInterceptRequest_Intercept() {}

func (*UpdateInterceptRequest_Id) isUpdateInterceptRequest_Intercept() {}
...
type RemoveInterceptRequest2 struct {
	...
	//
	// Types that are assignable to Intercept:
	//	*RemoveInterceptRequest2_Name
	//	*RemoveInterceptRequest2_Id
	Intercept isRemoveInterceptRequest2_Intercept `protobuf_oneof:"intercept"`
}
...
func (m *RemoveInterceptRequest2) GetIntercept() isRemoveInterceptRequest2_Intercept {
	if m != nil {
		return m.Intercept
	}
	return nil
...
func (x *RemoveInterceptRequest2) GetName() string {
	if x, ok := x.GetIntercept().(*RemoveInterceptRequest2_Name); ok {
		return x.Name
	}
	return ""
}

func (x *RemoveInterceptRequest2) GetId() string {
	if x, ok := x.GetIntercept().(*RemoveInterceptRequest2_Id); ok {
		return x.Id
	}
	return ""
}

type isRemoveInterceptRequest2_Intercept interface {
	isRemoveInterceptRequest2_Intercept()
}

type RemoveInterceptRequest2_Name struct {
	Name string `protobuf:"bytes,2,opt,name=name,proto3,oneof"`
}

type RemoveInterceptRequest2_Id struct {
	Id string `protobuf:"bytes,3,opt,name=id,proto3,oneof"`
}

func (*RemoveInterceptRequest2_Name) isRemoveInterceptRequest2_Intercept() {}

func (*RemoveInterceptRequest2_Id) isRemoveInterceptRequest2_Intercept() {}
...
var file_rpc_manager_manager_proto_rawDesc = []byte{
	...
	0x63, 0x22, 0xac, 0x02, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65,
	...
	0x52, 0x07, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12,
	0x10, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x51, 0x0a, 0x12, 0x61, 0x64, 0x64, 0x5f, 0x70, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77,
	...
	0x48, 0x01, 0x52, 0x10, 0x61, 0x64, 0x64, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x44, 0x6f,
	...
	0x01, 0x28, 0x08, 0x48, 0x01, 0x52, 0x13, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x50, 0x72, 0x65,
	0x76, 0x69, 0x65, 0x77, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x42, 0x0b, 0x0a, 0x09, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x63, 0x65, 0x70, 0x74, 0x42, 0x17, 0x0a, 0x15, 0x70, 0x72, 0x65, 0x76, 0x69,
	0x65, 0x77, 0x5f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x22, 0x8b, 0x01, 0x0a, 0x17, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72,
	...
	0x10, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x02, 0x69,
	0x64, 0x42, 0x0b, 0x0a, 0x09, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x63, 0x65, 0x70, 0x74, 0x22, 0xb7,
	0x02, 0x0a, 0x16, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x63, 0x65,
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x50, 0x0a, 0x0b, 0x64, 0x69, 0x73, 0x70, 0x6f, 0x73,
	...
	0x67, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x19, 0x0a,
	0x08, 0x73, 0x73, 0x68, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x07, 0x73, 0x73, 0x68, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x2e, 0x0a, 0x13, 0x6d, 0x65, 0x63, 0x68,
	...
	,
	...
	0x41, 0x52, 0x47, 0x53, 0x10, 0x08, 0x32, 0xc9, 0x07, 0x0a, 0x07, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0x12, 0x55, 0x0a, 0x0e, 0x41, 0x72, 0x72,
	...
	0x79, 0x12, 0x5b, 0x0a, 0x0b, 0x57, 0x61, 0x74, 0x63, 0x68, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x73,
	...
	0x74, 0x30, 0x01, 0x12, 0x64, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x74,
...
func file_rpc_manager_manager_proto_init() {
	...
	file_rpc_manager_manager_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*UpdateInterceptRequest_Name)(nil),
		(*UpdateInterceptRequest_Id)(nil),
	...
	file_rpc_manager_manager_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*RemoveInterceptRequest2_Name)(nil),
		(*RemoveInterceptRequest2_Id)(nil),
	}
	type x struct{}
