...
var file_rpc_manager_manager_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x22, 0x28, 0x0a, 0x0c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x6e,
	0x66, 0x6f, 0x32, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x56, 0x0a,
	0x07, 0x4c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6c, 0x69, 0x63, 0x65,
	...
	0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x6c, 0x75, 0x73,
	0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0x3f, 0x0a, 0x15, 0x41, 0x6d, 0x62, 0x61, 0x73, 0x73, 0x61,
	...
	0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x64, 0x0a, 0x11, 0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70,
	...
	0xfe, 0x0f, 0x0a, 0x07, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x12, 0x45, 0x0a, 0x07, 0x56,
	...
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x55, 0x0a, 0x0e, 0x41, 0x72, 0x72, 0x69, 0x76, 0x65, 0x41, 0x73,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x5b, 0x0a, 0x0b, 0x57, 0x61,
...
var file_rpc_manager_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_rpc_manager_manager_proto_goTypes = []interface{}{
	...
	(*VersionInfo2)(nil),              // 17: telepresence.manager.VersionInfo2
	(*License)(nil),                   // 18: telepresence.manager.License
	(*AmbassadorCloudConfig)(nil),     // 19: telepresence.manager.AmbassadorCloudConfig
	(*AmbassadorCloudConnection)(nil), // 20: telepresence.manager.AmbassadorCloudConnection
	(*ConnMessage)(nil),               // 21: telepresence.manager.ConnMessage
	(*LookupHostRequest)(nil),         // 22: telepresence.manager.LookupHostRequest
	(*LookupHostResponse)(nil),        // 23: telepresence.manager.LookupHostResponse
	(*LookupHostAgentResponse)(nil),   // 24: telepresence.manager.LookupHostAgentResponse
	(*IPNet)(nil),                     // 25: telepresence.manager.IPNet
	(*ClusterInfo)(nil),               // 26: telepresence.manager.ClusterInfo
	(*AgentInfo_Mechanism)(nil),       // 27: telepresence.manager.AgentInfo.Mechanism
	nil,                               // 28: telepresence.manager.AgentInfo.EnvironmentEntry
	(*durationpb.Duration)(nil),       // 29: google.protobuf.Duration
	(*emptypb.Empty)(nil),             // 30: google.protobuf.Empty
}
var file_rpc_manager_manager_proto_depIdxs = []int32{
	27, // 0: telepresence.manager.AgentInfo.mechanisms:type_name -> telepresence.manager.AgentInfo.Mechanism
	28, // 1: telepresence.manager.AgentInfo.environment:type_name -> telepresence.manager.AgentInfo.EnvironmentEntry
	...
	29, // 18: telepresence.manager.LogLevelRequest.duration:type_name -> google.protobuf.Duration
	7,  // 19: telepresence.manager.LookupHostRequest.session:type_name -> telepresence.manager.SessionInfo
	7,  // 20: telepresence.manager.LookupHostAgentResponse.session:type_name -> telepresence.manager.SessionInfo
	22, // 21: telepresence.manager.LookupHostAgentResponse.request:type_name -> telepresence.manager.LookupHostRequest
	23, // 22: telepresence.manager.LookupHostAgentResponse.response:type_name -> telepresence.manager.LookupHostResponse
	25, // 23: telepresence.manager.ClusterInfo.service_subnet:type_name -> telepresence.manager.IPNet
	25, // 24: telepresence.manager.ClusterInfo.pod_subnets:type_name -> telepresence.manager.IPNet
	30, // 25: telepresence.manager.Manager.Version:input_type -> google.protobuf.Empty
	30, // 26: telepresence.manager.Manager.GetLicense:input_type -> google.protobuf.Empty
	30, // 27: telepresence.manager.Manager.CanConnectAmbassadorCloud:input_type -> google.protobuf.Empty
	30, // 28: telepresence.manager.Manager.GetCloudConfig:input_type -> google.protobuf.Empty
	1,  // 29: telepresence.manager.Manager.ArriveAsClient:input_type -> telepresence.manager.ClientInfo
	2,  // 30: telepresence.manager.Manager.ArriveAsAgent:input_type -> telepresence.manager.AgentInfo
	15, // 31: telepresence.manager.Manager.Remain:input_type -> telepresence.manager.RemainRequest
	7,  // 32: telepresence.manager.Manager.Depart:input_type -> telepresence.manager.SessionInfo
	16, // 33: telepresence.manager.Manager.SetLogLevel:input_type -> telepresence.manager.LogLevelRequest
	7,  // 34: telepresence.manager.Manager.WatchAgents:input_type -> telepresence.manager.SessionInfo
	7,  // 35: telepresence.manager.Manager.WatchIntercepts:input_type -> telepresence.manager.SessionInfo
	7,  // 36: telepresence.manager.Manager.WatchClusterInfo:input_type -> telepresence.manager.SessionInfo
	10, // 37: telepresence.manager.Manager.CreateIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	12, // 38: telepresence.manager.Manager.RemoveIntercept:input_type -> telepresence.manager.RemoveInterceptRequest2
	11, // 39: telepresence.manager.Manager.UpdateIntercept:input_type -> telepresence.manager.UpdateInterceptRequest
	13, // 40: telepresence.manager.Manager.GetIntercept:input_type -> telepresence.manager.GetInterceptRequest
	14, // 41: telepresence.manager.Manager.ReviewIntercept:input_type -> telepresence.manager.ReviewInterceptRequest
	21, // 42: telepresence.manager.Manager.ClientTunnel:input_type -> telepresence.manager.ConnMessage
	21, // 43: telepresence.manager.Manager.AgentTunnel:input_type -> telepresence.manager.ConnMessage
	22, // 44: telepresence.manager.Manager.LookupHost:input_type -> telepresence.manager.LookupHostRequest
	24, // 45: telepresence.manager.Manager.AgentLookupHostResponse:input_type -> telepresence.manager.LookupHostAgentResponse
	7,  // 46: telepresence.manager.Manager.WatchLookupHost:input_type -> telepresence.manager.SessionInfo
	30, // 47: telepresence.manager.Manager.WatchLogLevel:input_type -> google.protobuf.Empty
	17, // 48: telepresence.manager.Manager.Version:output_type -> telepresence.manager.VersionInfo2
	18, // 49: telepresence.manager.Manager.GetLicense:output_type -> telepresence.manager.License
	20, // 50: telepresence.manager.Manager.CanConnectAmbassadorCloud:output_type -> telepresence.manager.AmbassadorCloudConnection
	19, // 51: telepresence.manager.Manager.GetCloudConfig:output_type -> telepresence.manager.AmbassadorCloudConfig
	7,  // 52: telepresence.manager.Manager.ArriveAsClient:output_type -> telepresence.manager.SessionInfo
	7,  // 53: telepresence.manager.Manager.ArriveAsAgent:output_type -> telepresence.manager.SessionInfo
	30, // 54: telepresence.manager.Manager.Remain:output_type -> google.protobuf.Empty
	30, // 55: telepresence.manager.Manager.Depart:output_type -> google.protobuf.Empty
	30, // 56: telepresence.manager.Manager.SetLogLevel:output_type -> google.protobuf.Empty
	8,  // 57: telepresence.manager.Manager.WatchAgents:output_type -> telepresence.manager.AgentInfoSnapshot
	9,  // 58: telepresence.manager.Manager.WatchIntercepts:output_type -> telepresence.manager.InterceptInfoSnapshot
	26, // 59: telepresence.manager.Manager.WatchClusterInfo:output_type -> telepresence.manager.ClusterInfo
	6,  // 60: telepresence.manager.Manager.CreateIntercept:output_type -> telepresence.manager.InterceptInfo
	30, // 61: telepresence.manager.Manager.RemoveIntercept:output_type -> google.protobuf.Empty
	6,  // 62: telepresence.manager.Manager.UpdateIntercept:output_type -> telepresence.manager.InterceptInfo
	6,  // 63: telepresence.manager.Manager.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	30, // 64: telepresence.manager.Manager.ReviewIntercept:output_type -> google.protobuf.Empty
	21, // 65: telepresence.manager.Manager.ClientTunnel:output_type -> telepresence.manager.ConnMessage
	21, // 66: telepresence.manager.Manager.AgentTunnel:output_type -> telepresence.manager.ConnMessage
	23, // 67: telepresence.manager.Manager.LookupHost:output_type -> telepresence.manager.LookupHostResponse
	30, // 68: telepresence.manager.Manager.AgentLookupHostResponse:output_type -> google.protobuf.Empty
	22, // 69: telepresence.manager.Manager.WatchLookupHost:output_type -> telepresence.manager.LookupHostRequest
	16, // 70: telepresence.manager.Manager.WatchLogLevel:output_type -> telepresence.manager.LogLevelRequest
