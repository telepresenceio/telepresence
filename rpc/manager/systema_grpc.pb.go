...
const (
	ManagerProxy_HandleConnection_FullMethodName = "/telepresence.manager.ManagerProxy/HandleConnection"
)
...
func (c *managerProxyClient) HandleConnection(ctx context.Context, opts ...grpc.CallOption) (ManagerProxy_HandleConnectionClient, error) {
	stream, err := c.cc.NewStream(ctx, &ManagerProxy_ServiceDesc.Streams[0], ManagerProxy_HandleConnection_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
