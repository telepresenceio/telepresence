...
func (c *managerClient) WatchAgentPods(ctx context.Context, in *SessionInfo, opts ...grpc.CallOption) (Manager_WatchAgentPodsClient, error) {
	...
	x := &managerWatchAgentPodsClient{ClientStream: stream}
...
func (c *managerClient) WatchAgents(ctx context.Context, in *SessionInfo, opts ...grpc.CallOption) (Manager_WatchAgentsClient, error) {
	...
	x := &managerWatchAgentsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *managerClient) WatchAgentsNS(ctx context.Context, in *AgentsRequest, opts ...grpc.CallOption) (Manager_WatchAgentsNSClient, error) {
	...
	x := &managerWatchAgentsNSClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *managerClient) WatchIntercepts(ctx context.Context, in *SessionInfo, opts ...grpc.CallOption) (Manager_WatchInterceptsClient, error) {
	...
	x := &managerWatchInterceptsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *managerClient) WatchWorkloads(ctx context.Context, in *WorkloadEventsRequest, opts ...grpc.CallOption) (Manager_WatchWorkloadsClient, error) {
	...
	x := &managerWatchWorkloadsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *managerClient) WatchClusterInfo(ctx context.Context, in *SessionInfo, opts ...grpc.CallOption) (Manager_WatchClusterInfoClient, error) {
	...
	x := &managerWatchClusterInfoClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *managerClient) WatchLookupDNS(ctx context.Context, in *SessionInfo, opts ...grpc.CallOption) (Manager_WatchLookupDNSClient, error) {
	...
	x := &managerWatchLookupDNSClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *managerClient) WatchLogLevel(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Manager_WatchLogLevelClient, error) {
	...
	x := &managerWatchLogLevelClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *managerClient) Tunnel(ctx context.Context, opts ...grpc.CallOption) (Manager_TunnelClient, error) {
	...
	x := &managerTunnelClient{ClientStream: stream}
	return x, nil
}
...
func (c *managerClient) WatchDial(ctx context.Context, in *SessionInfo, opts ...grpc.CallOption) (Manager_WatchDialClient, error) {
	...
	x := &managerWatchDialClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _Manager_WatchAgentPods_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchAgentPods(m, &managerWatchAgentPodsServer{ServerStream: stream})
}
...
func _Manager_WatchAgents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchAgents(m, &managerWatchAgentsServer{ServerStream: stream})
}
...
func _Manager_WatchAgentsNS_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchAgentsNS(m, &managerWatchAgentsNSServer{ServerStream: stream})
}
...
func _Manager_WatchIntercepts_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchIntercepts(m, &managerWatchInterceptsServer{ServerStream: stream})
}
...
func _Manager_WatchWorkloads_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchWorkloads(m, &managerWatchWorkloadsServer{ServerStream: stream})
}
...
func _Manager_WatchClusterInfo_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchClusterInfo(m, &managerWatchClusterInfoServer{ServerStream: stream})
}
...
func _Manager_WatchLookupDNS_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchLookupDNS(m, &managerWatchLookupDNSServer{ServerStream: stream})
}
...
func _Manager_WatchLogLevel_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchLogLevel(m, &managerWatchLogLevelServer{ServerStream: stream})
}
...
func _Manager_Tunnel_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ManagerServer).Tunnel(&managerTunnelServer{ServerStream: stream})
}
...
func _Manager_WatchDial_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagerServer).WatchDial(m, &managerWatchDialServer{ServerStream: stream})
}
